...
<div class="w3-padding-large" id="main">
  ...
  <div class="w3-content w3-justify w3-text-white w3-padding-64 " id="about">
    <h2 class="w3-text-yellow">SHARE MY PLAYLIST | What's on KD WORLD?</h2>
    <hr style="width:200px" class="w3-opacity">
    <p> 
    <p> MUSIC<font color= "yellow"></h2>
    <p><br>
     <font color= "yellow">There are hundreds of songs on KD World. Play your favorites, discover new tracks, and create the perfect collection.
    </p><br>
        
    <p>
        PLAYLIST<font color= "yellow"></h2>
    <p><br>
     <font color= "yellow">You’ll find readymade playlists to match your mood, put together by music fans and experts.
    </p><br>

    <p>  <font color= "yellow">It's fun and easy in KD World Studio</p><br>
    
    <p><br> 
        SEARCH<font color= "yellow"></h2>
     <p><br>
     </p>
     <font color= "yellow">Know what you want to listen to? Just search and hit play.
     </p><br>
    
    <p>
        BROWSE<font color= "yellow"></h2>
    <p><br>
      <font color= "yellow">Check out the latest charts, brand new releases and great playlists for right now.
     </p><br>

    <p>
        DISCOVER <font color= "yellow"></h2>
    <p><br>
       <font color= "yellow">Enjoy new music everyday with your own personal playlist. Or sit back and
       enjoy ready-made playlist.
    </p><br>
  ...
  <h3 class="w3-padding-24 w3-text-yellow">OUR TEAM </h3>  
    ...
    <p> HEAD OF THE PROJECT PLAN </p><br>
  ...
  <footer class="w3-content w3-padding-64 w3-text-grey w3-xlarge">
    ...
    <p class="w3-medium">Powered by <a href="https://github.com/COE11-USTP-CEA/KDWorld" target="_blank" class="w3-hover-text-yellow">KD WORLD/a></p>
  <!-- End footer -->
  </footer>
