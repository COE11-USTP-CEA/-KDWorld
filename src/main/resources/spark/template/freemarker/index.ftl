...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    ...
    <img src="http://hd-wall-papers.com/images/wallpapers/guitar-music-wallpaper/guitar-music-wallpaper-6.jpg" alt="boy" class="w3-image" width="992" height="1108">
  </header>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    ...
    <p><span class="w3-large w3-margin-right">Whillien Caturan</span> 
    ...
    <p><span class="w3-large w3-margin-right">Devi Obligado</span> 
    ...
    <p><span class="w3-large w3-margin-right">Vince Reycitez</span> 
  ...
  <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
    ...
    <div class="w3-section">
      ...
      <p><i class="fa fa-phone fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Phone: +123</p>
  ...
  <footer class="w3-content w3-padding-64 w3-text-grey w3-xlarge">
    ...
    <p class="w3-medium">Powered by <a href="https://github.com/COE11-USTP-CEA/KDWorld" target="_blank" class="w3-hover-text-green">pkmyo</a></p>
  <!-- End footer -->
  </footer>
